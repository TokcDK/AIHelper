...
namespace AIHelper.Manage
{
    static class ManageModOrganizer
    {
        ...
        internal class ModlistData
        {
            ...
            internal Dictionary<string, ModData> ModByName;
            ...
            public ModlistData()
            {
                ...
                ModByName = new Dictionary<string, ModData>();
                Load();
            }
            ...
            {
                if (ModByName.ContainsKey(itemName)) return ModByName[itemName];
